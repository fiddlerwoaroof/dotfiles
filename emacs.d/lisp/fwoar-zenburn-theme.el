...
(fwoar/zenburn-with-color-variables
  ...
  (custom-theme-set-faces
   ...
   `(helm-buffer-directory ((t (:foreground ,zenburn-red-6 :background ,zenburn-fg ))))
   ...
   `(diff-file-header ((t (:background ,zenburn-fg-1))))
   `(diff-header ((t (:background ,zenburn-bg+3))))
   ...
   `(diff-refine-changed ((t (:background ,zenburn-fg-1))))

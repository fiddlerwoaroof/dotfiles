...
(fwoar/zenburn-with-color-variables
  ...
  (custom-theme-set-faces
   ...
   `(helm-ff-backup-file ((t (:foreground ,zenburn-fg-1 ))))
   ...
   `(helm-ls-git-deleted-and-staged-face ((t (:foreground ,zenburn-red-3 ))))
   ...
   `(magit-dimmed ((t (:foreground ,zenburn-fg-2))))
   `(magit-hash ((t (:foreground ,zenburn-fg+1))))
